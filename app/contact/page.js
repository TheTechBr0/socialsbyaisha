    ...
    <SiteShell activePage="contact">
      <section className="mx-auto max-w-6xl px-6 py-16 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.3em] text-[#28c1a1]">Contact</p>
          ...
          <div className="rounded-[1.5rem] border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-6 space-y-4 text-sm text-slate-600">
              <a href="mailto:socialsbyaisha7@gmail.com" className="block rounded-2xl bg-[#f8f5ef] px-4 py-3 font-semibold text-[#28c1a1] transition hover:text-[#f59e0b]">
                socialsbyaisha7@gmail.com
              </a>
              <a href="tel:+233551528732" className="block rounded-2xl bg-[#f8f5ef] px-4 py-3 font-semibold text-[#28c1a1] transition hover:text-[#f59e0b]">
                0551528732
              </a>
